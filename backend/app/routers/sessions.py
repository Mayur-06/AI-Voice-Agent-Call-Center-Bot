...
from app.services.session import create_session, save_turn, load_turns, end_session
...
async def send_message(session_id: str, data: MessageRequest):
    ...
    response_text = await generate_response(history, "You are a helpful voice assistant.")
